        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          >
            ...
            <motion.p
              ...
              whileHover={{ x: 5 }}
            >
              "Confier à un professionnel RH votre gestion des ressources
              humaines pour optimiser votre capital humain."
            </motion.p>
            <motion.div
        ...
        >
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <motion.p
              ...
              whileHover={{ scale: 1.02 }}
            >
              © {new Date().getFullYear()} David Andriandislala. Tous droits
              réservés.
            </motion.p>
            <motion.p
