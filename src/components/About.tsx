...
import { Award, Users, Shield, CheckCircle, Lock, Heart, Sparkles } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="flex flex-col gap-8">
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-sm font-medium text-blue-600">EXPERT RH CERTIFIÉ</span>
              </div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Expertise RH <span className="text-blue-600 relative">
                  Sur Mesure
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed">
                <p className="text-lg">
                  Consultant RH indépendant avec <strong className="text-blue-600">20 ans d'expérience</strong> dans l'accompagnement stratégique des entreprises.
                </p>
                ...
                >
                  ...
                  <p>
                    Résoudre vos défis RH et améliorer durablement les performances de votre organisation.
                  </p>
                </motion.div>
              </div>
            </motion.div>
          ...
          <div className="space-y-8 sticky top-8">
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-3 relative z-10">Un projet RH ?</h3>
